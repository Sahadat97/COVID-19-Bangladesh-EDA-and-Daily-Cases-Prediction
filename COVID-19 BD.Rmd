...
output:
  ...
  html_notebook: rmarkdown::github_document
---
...
automl_leader1 <- automl_models_h2o1@leader

pred_h2o1 <- h2o.predict(automl_leader1, newdata = test_h2o)

h2o.performance(automl_leader1, newdata = test_h2o)
```

```{r}
automl_models_h2o2 <- h2o.automl(
    x = x, 
    y = y, 
    training_frame = train_h2o, 
    validation_frame = valid_h2o, 
...
automl_leader2 <- automl_models_h2o2@leader

pred_h2o2 <- h2o.predict(automl_leader2, newdata = test_h2o)

h2o.performance(automl_leader2, newdata = test_h2o)
```

```{r}
automl_models_h2o3 <- h2o.automl(
    x = x, 
    y = y, 
    training_frame = train_h2o, 
    validation_frame = valid_h2o, 
...
automl_leader3 <- automl_models_h2o3@leader

pred_h2o3 <- h2o.predict(automl_leader3, newdata = test_h2o)

h2o.performance(automl_leader3, newdata = test_h2o)
```

```{r}
automl_models_h2o4 <- h2o.automl(
    x = x, 
    y = y, 
    training_frame = train_h2o, 
    validation_frame = valid_h2o, 
...
automl_leader4 <- automl_models_h2o4@leader

pred_h2o4 <- h2o.predict(automl_leader4, newdata = test_h2o)

h2o.performance(automl_leader4, newdata = test_h2o)
```
...
automl_leader5 <- automl_models_h2o5@leader

pred_h2o5 <- h2o.predict(automl_leader5, newdata = test_h2o)

h2o.performance(automl_leader5, newdata = test_h2o)
```

```{r}

cdf %>% 
     selectByDate( start = "2021-01-01", end = "2021-02-12") %>%
...
new_d %>% 
  add_column(Predicted_cases = h2o.predict(automl_leader, newdata = new_h20) %>% 
  as_tibble() %>% 
  pull(predict))
