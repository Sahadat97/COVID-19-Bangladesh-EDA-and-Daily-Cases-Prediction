...
- Benchmarked four forecasting models — ARIMA (statistical baseline, RMSE: 514), Prophet (RMSE: 209, +59.3%), H2O AutoML (RMSE: 200, +61%), and LSTM (RMSE: 171, +66.6%) — with LSTM delivering the best performance using recursive one-step-ahead forecasting on a 20-day prediction window.
