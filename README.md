...
- Benchmarked four forecasting models — ARIMA (statistical baseline, RMSE: 513), Prophet (RMSE: 212, +58.7%), H2O AutoML (RMSE: 206, +59.9%), and LSTM (RMSE: 186, +63.7%) — with LSTM delivering the best performance using recursive one-step-ahead forecasting on a 20-day prediction window.
